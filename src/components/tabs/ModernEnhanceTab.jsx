      ...
      <GlassCard>
        <div className="space-y-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-xl font-semibold text-white">AI Prompt Enhancer</h3>
              <p className="text-sm text-white/60">Transform your ideas into detailed prompts</p>
            </div>
          </div>

          <div className="space-y-4">
            <label className="block text-sm font-medium text-white/80">Current Prompt:</label>
            <motion.textarea
              value={inputPrompt}
      ...
      <GlassCard>
        <div className="space-y-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-xl font-semibold text-white">Style Presets</h3>
              <p className="text-sm text-white/60">Quick apply professional enhancement styles</p>
            </div>
          </div>
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-xl font-semibold text-white">Manual Enhancement</h3>
                <p className="text-sm text-white/60">Pick individual styles to customize your prompt</p>
              </div>
            </div>
          ...
          <AnimatePresence>
            {selectedStyles.length > 0 && (
              ...
              >
                <h4 className="font-semibold text-white">Selected Styles ({selectedStyles.length}):</h4>
                <div className="flex flex-wrap gap-2">
