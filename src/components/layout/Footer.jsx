          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-center gap-3">
                ...
                <div className="text-left">
                  ...
                  <p className="text-sm text-white/60">AI Image Generator</p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-3 gap-8 py-8 border-y border-white/10">
              ...
              <div className="text-center">
                ...
                <div className="text-sm text-white/60">Style Presets</div>
              </div>
              <div className="text-center">
            ...
            {/* Tech Stack */}
            <div className="space-y-4">
              <p className="text-sm text-white/60">Powered by</p>
              <div className="flex flex-wrap justify-center gap-4 text-sm">
                <span className="px-3 py-1 bg-white/10 rounded-full text-white/70">React 19</span>
                <span className="px-3 py-1 bg-white/10 rounded-full text-white/70">Framer Motion</span>
                <span className="px-3 py-1 bg-white/10 rounded-full text-white/70">Tailwind CSS</span>
                <span className="px-3 py-1 bg-white/10 rounded-full text-white/70">Pollinations AI</span>
              </div>
            </div>
          </div>
        </GlassCard>
        ...
        <div className="mt-8 text-center">
          <div className="flex items-center justify-center gap-4 text-sm text-white/50">
            ...
            <div className="flex items-center gap-1">
              ...
              <span className="text-purple-400 font-medium">E1 AI</span>
            </div>
          </div>
        </div>
      </div>
